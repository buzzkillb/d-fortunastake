#!/bin/sh
TEMP=/tmp/answer$$
whiptail --title "Denarius [D]"  --menu  "FortunaStake :" 20 0 0 1 "Install Denarius FortunaStake" 2 "Update Denarius FortunaStake" 3 "Watch denariusd getinfo <ctrl+c> to exit" 2>$TEMP
choice=`cat $TEMP`
case $choice in
        1)      echo 1 "Installing Denarius FortunaStake"
...
watch -n 10 'denariusd getinfo'
                ;;
        2)      echo 2 "Updating Denarius FortunaStake"
echo "Stop denariusd"
denariusd stop
...
watch -n 10 'denariusd getinfo'
                ;;
        3)      echo 3 "Watch denariusd getinfo"
                watch -n 10 'denariusd getinfo'
                ;;
esac
